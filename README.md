...
Every line must be decided — turned into a hedge or removed — before the puzzle is complete. (Prefer to stop as soon as the path is fenced? Turn on Early finish in the preferences.) Use Undo, Redo, and Reset freely. Show Solution is available if you get stuck.
